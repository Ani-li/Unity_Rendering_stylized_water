Shader "Custom/speedtree_billboard"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Library/PackageCache/com.unity.render-pipelines.universal@14.0.7/Shaders/Nature/SpeedTree8Input.hlsl"
            #include "Library/PackageCache/com.unity.render-pipelines.universal@14.0.7/Shaders/Nature/SpeedTree8Passes.hlsl"
